                      ...
                      <table class="table">
                        <tr style="border: 1px solid black">
                          ...
                          >
                            ...
                            {{ billInfo[0].customers.com_name }}<br />
                            {{ billInfo[0].customers.address }}<br />
                            BIN: {{ billInfo[0].customers.bin_vat_etc }}
                          </td>
                          <td style="border: 1px solid black">
                            Invoice No.: BSCCL/BWP/IIG/BILL/SUMMIT/12-13/ <br />
                            Issue Date:
                            {{
                              moment(billInfo[0].bill_process_date).format(
                                "Do.MMMM .YYYY"
                              )
                            }}<br />
                            ...
                            {{
                              moment(billInfo[0].billing_month).format(
                                "MMMM.YYYY"
                              )
                            }}<br />

                            VAT Registration No.:
                            {{ billInfo[0].customers.bin_vat_etc }}
                          </td>
                        </tr>
                      </table>
                    </div>
                  ...
                  <div class="col-sm-12">
                    ...
                    >
                      ...
                      <tbody>
                        <tr style="border: 1px solid black">
                          <td>1</td>
                          <td style="font-size:15px; width:320px">
                          {{billInfo[0].circuit_id}}
                          {{circuitNameShow(billInfo[0].circuit_id)}}
                            IPLC (2xSTM-1) Half Circuit, Moghbazar-Chennai <br>
                            CD: COX/SUMMIT(01)ITC-CHN/BHA VC4S001 <br>
                            Activation Date: 17 April 2016 <br>
                            CD: COX/SUMMIT(02)ITC-CHN/BHA VC4S001 <br>
                          ...
                          <td class="text-right w-3">
                            {{
                              ...
                              " To " +
                              moment(billInfo[0].billing_month)
                                .add(1, "M")
                                .format("DD.MM.YYYY")
                            }}
                          </td>
                          <!-- <td>{{ billInfo.old_mrc_after_discount }}</td>
                          <td>{{ billInfo.mbc }}</td>
                          <td>
                            {{ billInfo.mbc + billInfo.old_mrc_after_discount }}
                          </td>
...
export default {
  ...
  methods: {
    ...
    circuitNameShow(item){

       circuitList = item.split(",");
