                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead style="border: 1px solid black">
                                                <tr style="border: 1px solid black">
                                                    ...
                                                    <th>Rate (BDT)</th>
                                                    <th>Rate After discount (BDT)</th>
                                                    <th>Rate After Following Slab (BDT)</th>
                                                    <th>Mrc colocation charge After Day Count (BDT)</th>
                                                    <th>Remarks</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td colspan="9">{{mrcForRunningBillAndAdjustableBill(billInfo.cableWiseBill, billInfo.adjustData)}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="9">{{subAdjustMontBillAndDemondnote(0, billInfo.oldMonthNetTotal, billInfo.cableWiseBill, billInfo.adjustData).toFixed(2)}} </td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right" colspan="6">
