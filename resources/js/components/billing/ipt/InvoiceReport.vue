            ...
            <div class="container-fluid">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead style="border: 1px solid black">
                                                <tr style="border: 1px solid black">
                                                    ...
                                                    <th>Rate (BDT)</th>
                                                    <th>Rate (After 10% Special Discount) (BDT)</th>
                                                    <th>Adjust (BDT)</th>
                                            ...
                                            <tbody>
                                                <tr style="border: 1px solid black">
                                                    ...
                                                    <td> {{ popWiseRateAndBandwithMultiply(billInfo.old_mrc_after_discount, billInfo.popWiseTotal, billInfo.mbc).toFixed(2)}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="9">{{subAdjustMontBillAndDemondnote(bandwithWiseRate, billInfo.adjustData).toFixed(2) }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right" colspan="7">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="11" class="text-center"> In words (Taka) :
                                                     {{ netTotalinAllCalculate() | toWords |capitalize }} BDT Only. </td>
                                                </tr>
                                                <!-- <tr>
                ...
                ></div> -->
                 ...
                 <div class="col-md-12 text-center pl-4 pb-4">
                    <p class="mb-0"> <strong> You are requested to make a payment within seven (07) working days. </strong></p>
                 </div>
