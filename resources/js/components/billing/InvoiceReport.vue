                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-if="billInfo.adjustData.length >= 0" v-for="adjust in billInfo.adjustData">
                                                    <td></td>
                                                    <td>{{adjust.circuit.circuit_name +' * '+ adjust.this_group_circuit}} <br> {{adjust.groups.group_name}}</td>
                                                    <td>{{ moment(adjust.sdate).format( "DD.MM.YYYY" )}} To
                                                       {{ moment(adjust.edate).format( "DD.MM.YYYY" )}}</td>
                                                    <td>{{adjust.rate.toFixed(2)}}</td>
                                                    <td>{{adjust.rate_after_discount.toFixed(2) }}</td>
                                                    <td>{{adjust.amount.toFixed(2) }}</td>
                                                    <td>N/A</td>
                                                    <td>{{adjust.amount.toFixed(2) }}</td>
                                                    <td></td>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td colspan="8">{{mrcForRunningBillAndAdjustableBill(billInfo.cableWiseBill, billInfo.adjustData).toFixed(2)}}</td>
                                                </tr>
                                                <tr v-if="billInfo.existingDemandNote >0">
                                                    <td style="text-align: right" colspan="7">
                                                        <strong class="text-center">Demand Note MRC Adjustment</strong>
                                                    </td>
                                                    <td colspan="8" >{{(billInfo.existingDemandNote).toFixed(2)}}</td>
                                                </tr>
                                                <tr v-if="billInfo.adjustData.length >0">
                                                    ...
                                                    <td colspan="8" > {{adjustNetTotalCaculation(billInfo.oldMonthNetTotal).toFixed(2)}} </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="8">{{subAdjustMontBillAndDemondnote(billInfo.existingDemandNote, billInfo.oldMonthNetTotal, billInfo.cableWiseBill, billInfo.adjustData).toFixed(2) }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right" colspan="7">
