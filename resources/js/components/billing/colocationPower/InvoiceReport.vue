                                    ...
                                    <div class="col-sm-12">
                                        <h6 class="text-center">
                                            <strong>Description of Bill
                                                ( {{billInfo.sub_service_name}} )</strong>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead style="border: 1px solid black">
                                                <tr style="border: 1px solid black">
                                                    ...
                                                    <th>Rate for Wet Segment</th>
                                                    <th>Rate for Wet Segment After Discount</th>
                                                    <th>Mrc For wet Segment After Day Count</th>
                                            ...
                                            <tbody>
                                                <tr style="border: 1px solid black">
                                                    <td>1</td>
                                                      <td>
                                                      <span v-for="(circuit,i) in billInfo.connectionInformation" :key="i">
                                                    ...
                                                    <td>
                                                        {{old_mrc(billInfo.cableWiseBill)}}
                                                    </td>

                                                    <td>
                                                        {{old_mrc_after_discount(billInfo.cableWiseBill)}}
                                                    </td>
                                                    <td>
                                                        {{old_mrc_after_discount(billInfo.cableWiseBill)}}
                                                    <td>
                                                    ...
                                                    <td>
                                                       {{mbcAndold_mrc_after_discount(billInfo.cableWiseBill)}}
                                                    </td>

                                                    <td>
                                                    {{ adjustCalculate(billInfo.cableWiseBill)}}
                                                ...
                                                <tr v-if="billInfo.adjustData.length >= 0" v-for="adjust in billInfo.adjustData">
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td colspan="9">{{mrcForRunningBillAndAdjustableBill(billInfo.cableWiseBill, billInfo.adjustData).toFixed(2)}}</td>
                                                </tr>
                                                <tr v-if="billInfo.existingDemandNote >0">
                                                    <td style="text-align: right" colspan="8">
                                                        <strong class="text-center">Demand Note MRC Adjustment</strong>
                                                    </td>
                                                    <td colspan="9" >{{(billInfo.existingDemandNote).toFixed(2)}}</td>
                                                </tr>
                                                <tr v-if="billInfo.adjustData.length >0">
                                                    <td style="text-align: right" colspan="8">
                                                        <strong class="text-center" >Adjustment. Of Bill {{billInfo.adjustData[0].adjust_month_name}} </strong>
                                                    </td>
                                                    <td colspan="9" > {{adjustNetTotalCaculation(billInfo.oldMonthNetTotal).toFixed(2)}} </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="9">{{subAdjustMontBillAndDemondnote(billInfo.existingDemandNote, billInfo.oldMonthNetTotal, billInfo.cableWiseBill, billInfo.adjustData).toFixed(2) }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right" colspan="8">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="11" class="text-center"> In words (Taka) :
                                                     {{ netTotalinAllCalculate() | toWords }} BDT Only. </td>
                                                </tr>
                                                <tr>
