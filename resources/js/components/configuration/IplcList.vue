                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(item, index) in listData" :key="index">
                                        ...
                                        <td>
                                            <button type="button" title="Edit" @click="editSubCategory(item)" class="btn btn-success btn-sm">
                                                <i class="fa fa-edit action-btn-font m-0"></i>
                                            </button>
                                            <button type="button" title="Delete User" class="btn btn-danger btn-sm" @click="deleteItem(listData)">
